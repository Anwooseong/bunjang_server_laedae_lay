...
public class GetProductDetailRes {
   ...
   private List<String> tags;
    ...
    public GetProductDetailRes(int price, String isSafePay, String title, String locationAddress, String createdAt, int view, String hasDeliveryFee, String isNew, int amount, String isInterchangeable, String content, String categoryImg, String categoryTitle, String brandImg, String brandName) {
        this.price = price;
